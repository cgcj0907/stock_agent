...
| 周期型 | 正常化盈利 × 历史中位 PE + EV/EBITDA + 重置成本 | 用景气高点盈利做 DCF |
| 金融型 | PB + ROE 盈利能力法 + 股息率 | 现金流折现（不适用） |
| 资产型/困境 | NAV / 清算价值 / NCAV | 盈利倍数法 |
| 高分红稳定型 | DDM + 股息率 vs 无风险利率 | — |

- **输出约定**：
  1. 内在价值 = **[下沿, 上沿]** 区间（多模型交叉的保守包络）；
